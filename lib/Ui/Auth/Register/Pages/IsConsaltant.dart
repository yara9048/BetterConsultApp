...
import 'package:untitled6/Providers/Home/User/Others/SendApplicationProvider.dart';
...
class _IsconsaltantState extends State<Isconsaltant> {
  ...
  File _getFileFromPlatformFile(PlatformFile platformFile) {
  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider(
      create: (_) => SendApplicationProvider(),
      child: Consumer<SendApplicationProvider>(
                    ...
                    children: [
                      ...
                      Text(
                        ...
                        style: TextStyle(color: Theme
                            ...
                            .colorScheme
                            .surface
                            .withOpacity(0.4), fontFamily: 'NotoSerifGeorgian'
                        ),),
                      SizedBox(height: 10,),
                      Container(
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () async {
                              if (_formKey.currentState!.validate()) {
                                ...
                                provider.sendApplication(
                                    location: _locationController.text,
                                    description: _bioController.text,
                                    cost: _costController.text,
                                    domain: _fieldController.text,
                                    subDomain: _specializationController.text,
