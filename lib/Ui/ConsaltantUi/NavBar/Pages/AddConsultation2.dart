...
import '../Component/InputCard2.dart';
import '../Component/OptionCard.dart';


class AddConsultation2 extends StatefulWidget {
  final int id;
  const AddConsultation2({super.key, required this.id});

  @override
  State<AddConsultation2> createState() => _AddConsultationState();
}

class _AddConsultationState extends State<AddConsultation2> {
