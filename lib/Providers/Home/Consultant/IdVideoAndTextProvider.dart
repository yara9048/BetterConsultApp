...
class IdVideoAndTextProvider with ChangeNotifier {
  ...
  Future<void> idVideoAndVoiceUploading(File file, {required bool isVideo,  required int waiting_question_id}) async {
    _isLoading = true;
    _errorMessage = null;
    _isSuccess = false;
    ...
    final String url = Endpoints.baseUrl + Endpoints.answeringWaitingFile;
